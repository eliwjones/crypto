...
func TestKeyGeneration(t *testing.T) {
	...
	testKeyGeneration(t, elliptic.Secp256k1(), "secp256k1")
}
...
func TestSignAndVerify(t *testing.T) {
	...
	testSignAndVerify(t, elliptic.Secp256k1(), "secp256k1")
}
...
func TestNonceSafety(t *testing.T) {
	...
	testNonceSafety(t, elliptic.Secp256k1(), "secp256k1")
}
...
func TestINDCCA(t *testing.T) {
	...
	testINDCCA(t, elliptic.Secp256k1(), "secp256k1")
}
...
func TestNegativeInputs(t *testing.T) {
	...
	testNegativeInputs(t, elliptic.Secp256k1(), "secp256k1")
}

func TestZeroHashSignature(t *testing.T) {
	zeroHash := make([]byte, 64)

	for _, curve := range []elliptic.Curve{elliptic.P224(), elliptic.P256(), elliptic.P384(), elliptic.P521(), elliptic.Secp256k1()} {
